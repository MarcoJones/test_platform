# Generated by Django 3.2.15 on 2022-08-30 16:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.CharField(default='', max_length=100, verbose_name='创建人')),
                ('extract_var', models.CharField(max_length=1024, null=True, verbose_name='提取变量表达式')),
                ('request_method', models.CharField(max_length=100, null=True, verbose_name='请求方式')),
                ('status', models.IntegerField(help_text='0:表示有效；1：表示无效', verbose_name='用例状态')),
